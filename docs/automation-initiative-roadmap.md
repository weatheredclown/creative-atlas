...
- ✅ Re-applied the fix removing the unsupported `allowedFunctionNames` tool config so the Gemini computer-use model accepts ghost agent requests again after the regression resurfaced.
