export const tutorialSteps = [
  {
    ...
    explanation:
      "This tutorial will guide you through creating your first world. Let's start by creating a new world.",
    action: 'Create a New World',
  },
  {
    title: 'Creating Your World',
    explanation:
      "Every great story starts with a world. Give your world a name and a brief description. For our tutorial, we'll use the world of Aethelgard.",
    action: 'Fill in world details',
  },
  {
    title: 'Your World Dashboard',
    explanation:
      "This is your world dashboard, where you can manage all your projects. Let's add your first project: a world-building wiki.",
