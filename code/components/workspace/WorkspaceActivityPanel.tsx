...
const WorkspaceActivityPanel: React.FC<WorkspaceActivityPanelProps> = ({
  ...
  return (
    ...
    <section id="workspace-tracking" className="space-y-4 scroll-mt-28">
      <div>
    ...
    <section id="distribution" className="space-y-6">
      ...
      <div className="space-y-10">
        {visibilitySettings.templates ? (
          <section id="workspace-templates" className="space-y-6 scroll-mt-28">
            <TemplateWorkspace
              projectTitle={project.title}
        ...
        {(visibilitySettings.releaseWorkflows || visibilitySettings.githubImport) ? (
          <section id="workspace-publishing" className="space-y-6 scroll-mt-28">
            <div
