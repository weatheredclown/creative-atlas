                ...
                >
                  ...
                  {showDetailedFields && (
                    <button
                      ...
                      className="text-slate-400 hover:text-red-400 focus:outline-none focus:ring-2 focus:ring-red-400 rounded-md"
                  ...
                  {isAddingTag ? (
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-700/70 text-slate-300 hover:bg-slate-600/70 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-800"
                ...
                return (
                  <div key={`${relation.toId}-${index}`} className="flex items-center gap-2 text-sm bg-slate-700/50 px-3 py-1.5 rounded-md">
                    ...
                    <button
                      ...
                      className="ml-auto p-1 text-slate-400 hover:text-red-400 transition focus:outline-none focus:ring-2 focus:ring-red-400 rounded-md"
                  ...
                  return (
                    <li key={`${relation.toId}-${index}`} className="rounded-md border border-slate-700/60 bg-slate-800/40 px-3 py-2">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleRemoveRelation(index)}
                          className="ml-auto text-slate-500 hover:text-red-400 transition focus:outline-none focus:ring-2 focus:ring-red-400 rounded-md"
                          aria-label={`Remove relation ${relation.kind} to ${target?.title ?? relation.toId}`}
                          title="Remove relation"
                        >
                          <XMarkIcon className="w-4 h-4" />
